...
- `transition` permet d'adoucir le changement de largeur.
...
- faire varier la largeur du recto avec une transition ;
...
- Ne pas coder deux boutons : la carte elle-meme est interactive.
